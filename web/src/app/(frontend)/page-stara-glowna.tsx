// ODPIĘTA stara strona główna PLŻ (hero, aktualności, mistrzowie, sponsorzy).
// Ten plik NIE jest routowany (nie nazywa się page.tsx) — trzymamy go na później.
// Aby przywrócić jako stronę główną: skopiuj zawartość do page.tsx.
...
export default async function StaraGlownaPage() {
