...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "kluby".
 */
export interface Kluby {
  id: number;
  nazwa: string;
  skrot?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "kluby_select".
 */
export interface KlubySelect<T extends boolean = true> {
  nazwa?: T;
  skrot?: T;
  logo?: T;
  gdzieStartuje?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "sponsorzy_select".
 */
export interface SponsorzySelect<T extends boolean = true> {
  nazwa?: T;
  logo?: T;
  link?: T;
  kategoria?: T;
